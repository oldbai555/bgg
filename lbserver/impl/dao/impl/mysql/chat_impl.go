...
var _ dao.IChatDao = (*ChatImpl)(nil)
...
func (a *ChatImpl) FindPaginate(ctx context.Context, options *lb.Options) ([]*lbim.ModelChat, *lb.Paginate, error) {
...
func NewChatImpl(ctx context.Context, dsn string) (dao.IChatDao, error) {
	var d = &ChatImpl{
		mysqlConn{
			dsn: dsn,
		},
