...
var _ dao.ICustomerDao = (*CustomerImpl)(nil)
...
func (a *CustomerImpl) FindPaginate(ctx context.Context, options *lb.Options) ([]*lbcustomer.ModelCustomer, *lb.Paginate, error) {
...
func NewCustomerImpl(ctx context.Context, dsn string) (dao.ICustomerDao, error) {
	var d = &CustomerImpl{
		mysqlConn{
			dsn: dsn,
		},
