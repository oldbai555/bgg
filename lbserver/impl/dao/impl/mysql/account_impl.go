...
var _ dao.IAccountDao = (*AccountImpl)(nil)
...
func (a *AccountImpl) FindPaginate(ctx context.Context, options *lb.Options) ([]*lbaccount.ModelAccount, *lb.Paginate, error) {
...
func NewAccountImpl(ctx context.Context, dsn string) (dao.IAccountDao, error) {
	var d = &AccountImpl{
		mysqlConn{
			dsn: dsn,
		},
