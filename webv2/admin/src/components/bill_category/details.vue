      ...
      <a-spin tip="loading..." :spinning="loading">
        ...
        <a-form ref="formRef" :model="formState" layout="vertical">
          ...
          <a-form-item name="name" label="分类名称">
            <a-input v-model:value="formState.name" :allowClear="true" :showCount="true" disabled/>
          </a-form-item>


          <!--    表单字段    -->
          <a-form-item name="root_category" label="收入/支出">
            <a-select style="width: 130px" placeholder="请选择" v-model:value="formState.root_category" disabled>
