...
import {GetBillCategoryListReq_Option, GetBillListReq_Option} from "@/plugin/api/model/lbbill";
...
const handleSearch = (searchValue: string) => {
  opts.opt_list = replaceOps(opts.opt_list, {
    key: GetBillCategoryListReq_Option.OptionLikeName,
    value: searchValue
  })
  getList(opts)
