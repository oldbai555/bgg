      ...
      <a-spin tip="loading..." :spinning="loading">
        ...
        <a-form ref="formRef" :model="formState" layout="vertical">
          ...
          <a-form-item name="username" label="账号">
            <a-input v-model:value="formState.username" :allowClear="true" :showCount="true" disabled/>
          </a-form-item>

          <!--    表单字段    -->
          <a-form-item name="nickname" label="昵称">
            <a-input v-model:value="formState.nickname" :allowClear="true" :showCount="true" disabled/>
          </a-form-item>


          <!--    表单字段    -->
          <a-form-item name="email" label="邮箱">
            <a-input v-model:value="formState.email" :allowClear="true" :showCount="true" disabled/>
          </a-form-item>

          <!--    表单字段    -->
          <a-form-item name="desc" label="描述">
            <a-input v-model:value="formState.desc" :allowClear="true" :showCount="true" disabled/>
          </a-form-item>
          ...
          <a :href="formState.github" target="_blank">{{ formState.github }}</a>
        </a-form>
      </a-spin>
    </a-modal>
  </div>
...
const show = async (id: number | undefined) => {
  ...
  if (id) {
    try {
      const resp = await lbuser.getUser({id: id});
      formState.value = resp.user;
    } catch (error: any) {
      message.error(error);
    }
  }
