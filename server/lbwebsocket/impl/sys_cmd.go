...
func StartServer() error {
	...
	s := grpc.NewServer()
	// 3.在gRPC上注册微服务
	lbwebsocket.RegisterLbwebsocketServer(s, &lbwebsocketServer)
	// 4.启动服务端
...
func initViper() (*viper.Viper, error) {
	...
	viper.AddConfigPath("./server/lbwebsocket/cmd/") // optionally look for config in the working directory
