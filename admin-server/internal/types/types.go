...
type BlogArticleItem struct {
	...
	IsTop       int64    `json:"isTop"`             // 是否置顶：0=否，1=是
	CreatedAt   int64    `json:"createdAt"`         // 创建时间(秒级时间戳)
...
type BlogArticleUntopReq struct {
	Id uint64 `json:"id"` // 文章ID
}
...
type BlogFriendLinkCreateReq struct {
	Name     string `json:"name"`              // 链接名称
	Url      string `json:"url"`               // 目标链接
	Remark   string `json:"remark,optional"`   // 备注
	Status   int64  `json:"status"`            // 状态：1=启用，2=禁用
	OrderNum int64  `json:"orderNum,optional"` // 排序值
}

type BlogFriendLinkDeleteReq struct {
	Id uint64 `json:"id"`
}
...
type BlogFriendLinkListReq struct {
	Page    int64  `json:"page,optional" form:"page,optional"`
	Size    int64  `json:"size,optional" form:"size,optional"`
	Status  int64  `json:"status,optional" form:"status,optional"`   // 状态筛选（0=全部，1=启用，2=禁用）
	Keyword string `json:"keyword,optional" form:"keyword,optional"` // 名称/备注搜索
}

type BlogFriendLinkListResp struct {
	List  []BlogFriendLinkItem `json:"list"`
	Page  int64                `json:"page"`
	Size  int64                `json:"size"`
	Total int64                `json:"total"`
}

type BlogFriendLinkUpdateReq struct {
	Id       uint64 `json:"id"`
	Name     string `json:"name,optional"`
...
type BlogSocialInfoCreateReq struct {
	Name     string `json:"name"`              // 社交平台名称
	Url      string `json:"url"`               // 目标链接
	Remark   string `json:"remark,optional"`   // 备注
	Status   int64  `json:"status"`            // 状态：1=启用，2=禁用
	OrderNum int64  `json:"orderNum,optional"` // 排序值
...
type BlogSocialInfoDeleteReq struct {
	Id uint64 `json:"id"`
}
...
type BlogSocialInfoListReq struct {
	Page    int64  `json:"page,optional" form:"page,optional"`
	Size    int64  `json:"size,optional" form:"size,optional"`
	Status  int64  `json:"status,optional" form:"status,optional"`   // 状态筛选（0=全部，1=启用，2=禁用）
	Keyword string `json:"keyword,optional" form:"keyword,optional"` // 名称/备注搜索
...
type BlogSocialInfoListResp struct {
	List  []BlogSocialInfoItem `json:"list"`
	Page  int64                `json:"page"`
	Size  int64                `json:"size"`
	Total int64                `json:"total"`
}

type BlogSocialInfoUpdateReq struct {
	Id       uint64 `json:"id"`
	Name     string `json:"name,optional"`
	Url      string `json:"url,optional"`
	Remark   string `json:"remark,optional"`
...
type PublicBlogFriendLinkListResp struct {
	List []PublicBlogFriendLinkItem `json:"list"`
}
...
type PublicBlogSocialInfoListResp struct {
	List []PublicBlogSocialInfoItem `json:"list"`
}

type PublicBlogTagListResp struct {
	List []BlogTagItem `json:"list"`
}
