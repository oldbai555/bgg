...
type rolePermissionRepository struct {
	model iammodel.AdminRolePermissionModel
	conn  sqlx.SqlConn
}

func NewRolePermissionRepository(repo *repository.Repository) RolePermissionRepository {
...
func (r *rolePermissionRepository) ListPermissionIDsByRoleID(ctx context.Context, roleID uint64) ([]uint64, error) {
	var list []iammodel.AdminRolePermission
