...
// iam+system+monitoring+misc 域拆分成 iam-rpc 后，Login/RBAC/Transact 的真实业务逻辑都在这里，
// 不再在 gateway（gateway 侧现在只是调 IamRPC 的薄胶水，没有可以直连真实 MySQL 集成测试的业务逻辑）。
	...
	svcCtx := &svc.ServiceContext{
		...
		Config: config.Config{
			JWT: struct {
				...
				AccessExpire:  3600,
				RefreshExpire: 86400,
				Issuer:        "iam-rpc-integration-test",
			},
		},
	}
