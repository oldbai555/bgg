...
func initViper() (*viper.Viper, error) {
	viper.SetConfigName("lbblog_application")                                                             // name of config file (without extension)
	viper.SetConfigType("yaml")                                                                           // REQUIRED if the config file does not have the extension in the name
	viper.AddConfigPath("/etc/work/")                                                                     // path to look for the config file in
	viper.AddConfigPath("/Users/zhangjianjun/work/lb/github.com/oldbai555/bgg/service/lbblog/impl/conf/") // path to look for the config file in
