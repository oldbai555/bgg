...
func (a *ArticleImpl) GetOrmEngine(ctx context.Context) *gorm.DB {
	return MasterOrm.WithContext(ctx).Model(&lbblog.ModelArticle{})
}

func (a *ArticleImpl) Create(ctx context.Context, val *lbblog.ModelArticle) (*webtool.Result, error) {
...
func (a *ArticleImpl) FirstOrCreate(ctx context.Context, cand map[string]interface{}, val *lbblog.ModelArticle) (*webtool.Result, error) {
...
func (a *ArticleImpl) BatchCreate(ctx context.Context, valList []*lbblog.ModelArticle) (*webtool.Result, error) {
...
func (a *ArticleImpl) UpdateOrCreate(ctx context.Context, candMap, attrMap map[string]interface{}, out *lbblog.ModelArticle) (*webtool.Result, error) {
...
func (a *ArticleImpl) UpdateById(ctx context.Context, id uint64, updateMap map[string]interface{}) (*webtool.Result, error) {
	db := a.GetOrmCondBuilder(ctx)
...
func (a *ArticleImpl) UpdateByIdList(ctx context.Context, idList []uint64, updateMap map[string]interface{}) (*webtool.Result, error) {
	db := a.GetOrmCondBuilder(ctx)
...
func (a *ArticleImpl) DeleteById(ctx context.Context, id uint64) (*webtool.Result, error) {
	db := a.GetOrmCondBuilder(ctx)
	rows, err := db.Eq(lbblog.FieldId_, id).Delete(ctx, &lbblog.ModelArticle{})
	if err != nil {
		log.Errorf("err:%v", err)
		return nil, err
	}
...
func (a *ArticleImpl) DeleteByIdList(ctx context.Context, idList []uint64) (*webtool.Result, error) {
	db := a.GetOrmCondBuilder(ctx)
	rows, err := db.In(lbblog.FieldId_, idList).Delete(ctx, &lbblog.ModelArticle{})
	if err != nil {
		log.Errorf("err:%v", err)
		return nil, err
	}
...
func (a *ArticleImpl) Increment(ctx context.Context, field string, num uint32, candMap map[string]interface{}) error {
	if len(candMap) == 0 {
...
func (a *ArticleImpl) Decrement(ctx context.Context, field string, num uint32, candMap map[string]interface{}) error {
	if len(candMap) == 0 {
		return lberr.NewInvalidArg("candMap must be not nil")
	}
	db := a.GetOrmCondBuilder(ctx)
...
func (a *ArticleImpl) IsNotFoundErr(err error) bool {
	return err == gorm.ErrRecordNotFound
}

func (a *ArticleImpl) GetList(ctx context.Context, candMap map[string]interface{}, opts ...*webtool.Opt) ([]*lbblog.ModelArticle, error) {
	var list []*lbblog.ModelArticle
	db := a.GetOrmCondBuilder(ctx)
...
func (a *ArticleImpl) GetOne(ctx context.Context, candMap map[string]interface{}, opts ...*webtool.Opt) (*lbblog.ModelArticle, error) {
	var val lbblog.ModelArticle
	db := a.GetOrmCondBuilder(ctx)
	webtool.ProcessOpts(db, opts...)
...
func (a *ArticleImpl) GetOrmCondBuilder(ctx context.Context) *webtool.OrmCondBuilder {
	return webtool.NewCondBuilder(a.GetOrmEngine(ctx))
}

func NewArticleImpl() (dao.IArticleDao, error) {
	return &ArticleImpl{}, nil
}
