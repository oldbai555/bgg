...
import (
	...
	"github.com/oldbai555/bgg/service/lbstore/impl/conf"
	"github.com/oldbai555/bgg/service/lbstore/impl/dao/impl/mysql"
	"github.com/oldbai555/bgg/service/lbstore/impl/service"
...
func Run(ctx *cli.Context) error {
	...
	// 在gRPC服务器注册我们的服务
	lbstore.RegisterLbstoreServer(grpcServer, &service.StoreServer)
