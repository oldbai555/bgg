...
// Validate checks the field values on GenArticleVo with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *GenArticleVo) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GenArticleVo with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in GenArticleVoMultiError, or
// nil if none found.
func (m *GenArticleVo) ValidateAll() error {
	return m.validate(true)
}

func (m *GenArticleVo) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	// no validation rules for BannerText

	// no validation rules for Date

	if len(errors) > 0 {
		return GenArticleVoMultiError(errors)
	}

	return nil
}

// GenArticleVoMultiError is an error wrapping multiple validation errors
// returned by GenArticleVo.ValidateAll() if the designated constraints aren't met.
type GenArticleVoMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GenArticleVoMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GenArticleVoMultiError) AllErrors() []error { return m }

// GenArticleVoValidationError is the validation error returned by
// GenArticleVo.Validate if the designated constraints aren't met.
type GenArticleVoValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GenArticleVoValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GenArticleVoValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GenArticleVoValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GenArticleVoValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GenArticleVoValidationError) ErrorName() string { return "GenArticleVoValidationError" }

// Error satisfies the builtin error interface
func (e GenArticleVoValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = GenArticleVoValidationError{}
