...
type BaseUser struct {
	...
	Type      uint32 `protobuf:"varint,10,opt,name=type,proto3" json:"type,omitempty"` // 0 默认系统用户 1 微信小程序用户
}
...
func (x *BaseUser) GetCreatedAt() uint32 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
func (x *BaseUser) GetType() uint32 {
	if x != nil {
		return x.Type
	}
	return 0
...
type JsCodeToSessionReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *JsCodeToSessionReq) Reset() {
	*x = JsCodeToSessionReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *JsCodeToSessionReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*JsCodeToSessionReq) ProtoMessage() {}

func (x *JsCodeToSessionReq) ProtoReflect() protoreflect.Message {
	mi := &file_lbsinglest_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use JsCodeToSessionReq.ProtoReflect.Descriptor instead.
func (*JsCodeToSessionReq) Descriptor() ([]byte, []int) {
	return file_lbsinglest_proto_rawDescGZIP(), []int{6}
}

func (x *JsCodeToSessionReq) GetJsCode() string {
	if x != nil {
		return x.JsCode
	}
	return ""
...
func (x *JsCodeToSessionReq) GetAppid() string {
	if x != nil {
		return x.Appid
	}
	return ""
...
func (x *JsCodeToSessionReq) GetSecret() string {
	if x != nil {
		return x.Secret
	}
	return ""
...
type JsCodeToSessionRsp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *JsCodeToSessionRsp) Reset() {
	*x = JsCodeToSessionRsp{}
	if protoimpl.UnsafeEnabled {
...
func (x *JsCodeToSessionRsp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*JsCodeToSessionRsp) ProtoMessage() {}

func (x *JsCodeToSessionRsp) ProtoReflect() protoreflect.Message {
	mi := &file_lbsinglest_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use JsCodeToSessionRsp.ProtoReflect.Descriptor instead.
func (*JsCodeToSessionRsp) Descriptor() ([]byte, []int) {
	return file_lbsinglest_proto_rawDescGZIP(), []int{7}
}

func (x *JsCodeToSessionRsp) GetSessionKey() string {
	if x != nil {
		return x.SessionKey
	}
	return ""
...
func (x *JsCodeToSessionRsp) GetUnionid() string {
	if x != nil {
		return x.Unionid
	}
	return ""
...
func (x *JsCodeToSessionRsp) GetErrmsg() string {
	if x != nil {
		return x.Errmsg
	}
	return ""
...
func (x *JsCodeToSessionRsp) GetOpenid() string {
	if x != nil {
		return x.Openid
	}
	return ""
...
func (x *JsCodeToSessionRsp) GetErrcode() int32 {
	if x != nil {
		return x.Errcode
	}
	return 0
...
var file_lbsinglest_proto_rawDesc = []byte{
	...
	0x6c, 0x22, 0xf3, 0x01, 0x0a, 0x08, 0x42, 0x61, 0x73, 0x65, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e,
	...
	0x64, 0x41, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x2b, 0x0a, 0x05, 0x4c, 0x6f, 0x67, 0x69, 0x6e,
	...
	0x03, 0x75, 0x69, 0x64, 0x22, 0x5a, 0x0a, 0x0c, 0x4a, 0x6f, 0x69, 0x6e, 0x43, 0x68, 0x61, 0x74,
	0x52, 0x6f, 0x6f, 0x6d, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x6f, 0x6f, 0x6d, 0x49, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x72, 0x6f, 0x6f, 0x6d, 0x49, 0x64, 0x12, 0x32, 0x0a, 0x06,
	0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x6c,
	0x62, 0x73, 0x69, 0x6e, 0x67, 0x6c, 0x65, 0x73, 0x74, 0x2e, 0x43, 0x68, 0x61, 0x74, 0x52, 0x6f,
	0x6f, 0x6d, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x52, 0x06, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72,
	0x22, 0x5b, 0x0a, 0x0d, 0x4c, 0x65, 0x61, 0x76, 0x65, 0x43, 0x68, 0x61, 0x74, 0x52, 0x6f, 0x6f,
	...
	0x65, 0x6d, 0x62, 0x65, 0x72, 0x52, 0x06, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x3e, 0x0a,
	0x0e, 0x43, 0x68, 0x61, 0x74, 0x52, 0x6f, 0x6f, 0x6d, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x12,
	...
	0x12, 0x4a, 0x73, 0x43, 0x6f, 0x64, 0x65, 0x54, 0x6f, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	0x52, 0x65, 0x71, 0x12, 0x17, 0x0a, 0x07, 0x6a, 0x73, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x01,
	...
	0x28, 0x09, 0x52, 0x06, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x22, 0x99, 0x01, 0x0a, 0x12, 0x4a,
	0x73, 0x43, 0x6f, 0x64, 0x65, 0x54, 0x6f, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x73,
	0x70, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x6b, 0x65, 0x79,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x4b,
	0x65, 0x79, 0x12, 0x18, 0x0a, 0x07, 0x75, 0x6e, 0x69, 0x6f, 0x6e, 0x69, 0x64, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x07, 0x75, 0x6e, 0x69, 0x6f, 0x6e, 0x69, 0x64, 0x12, 0x16, 0x0a, 0x06,
	...
	0x6c, 0x65, 0x73, 0x74, 0x42, 0x2b, 0x5a, 0x29, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
func file_lbsinglest_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_lbsinglest_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*JsCodeToSessionReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_lbsinglest_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*JsCodeToSessionRsp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
