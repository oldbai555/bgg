...
// Validate checks the field values on WebsocketData with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *WebsocketData) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on WebsocketData with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in WebsocketDataMultiError, or
// nil if none found.
func (m *WebsocketData) ValidateAll() error {
	return m.validate(true)
}

func (m *WebsocketData) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, WebsocketDataValidationError{
					field:  "Message",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return WebsocketDataValidationError{
				field:  "Message",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return WebsocketDataMultiError(errors)
	}

	return nil
}

// WebsocketDataMultiError is an error wrapping multiple validation errors
// returned by WebsocketData.ValidateAll() if the designated constraints
// aren't met.
type WebsocketDataMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m WebsocketDataMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m WebsocketDataMultiError) AllErrors() []error { return m }

// WebsocketDataValidationError is the validation error returned by
// WebsocketData.Validate if the designated constraints aren't met.
type WebsocketDataValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e WebsocketDataValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e WebsocketDataValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e WebsocketDataValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e WebsocketDataValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e WebsocketDataValidationError) ErrorName() string { return "WebsocketDataValidationError" }

// Error satisfies the builtin error interface
func (e WebsocketDataValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = WebsocketDataValidationError{}
